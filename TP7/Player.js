class player {
    constructor(id, name, skinId, lvl, position, HP, HPmax, hitbox, damagehitbox, HPregenrate) {
        ...
        // Variables d'animation initialisées pour éviter les erreurs
        this.currentWalkSpriteStep = 0;
        this.walkSpriteIndex = 0;
        this.walkSpriteDuration = 10; 
        this.walkSpritesNumber = 4;
    }
    ...
    update(updateData) {
        ...
        if (updateData.HPmax) {
            ...
            console.log("HPmax mis à jour :", this.HPmax);
        }
    }
    ...
    animate() {
        ...
        // Logs de debug d'animation déplacés ici pour être fonctionnels
        this.logAnimation();
    }
